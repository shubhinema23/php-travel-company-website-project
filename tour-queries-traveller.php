...
$arrFilter['TravelAddedBy'] = $agentID;
				...
				<div class=" tour-detail-list row no-negative-margin bg-white mb-5 "  >
					...
					<div class="col-lg-6  col-xs-12 col-sm-12  tour-info pt-3 pb-3">				
						...
						<div class="col-lg-2  col-xs-12 col-sm-12  tour-cost pt-3 pb-3">	
							...
							<button type="button" class="btn btn-info btn-sm"><a href="tour-queries-travellerdetail.php?QueryId=<?php echo $travelID; ?>" class="text-white" >View Query</a></button>
						</div>
